...
export const flowNodes: readonly FlowNode[] = [
  {
    ...
    description:
      "Registered client apps that write through Trust API. Live count comes from applications.list; registration and connection packs live in Connections.",
    features: [
  ...
  },
  {
    ...
    description:
      "Content-addressed blobs via storage adapters. Download grants are live; public multipart upload and storage admin UI remain outstanding.",
    features: [
      "Content-addressed blobs",
      "Policy-gated download grants",
      "Quarantine scan status",
      "Multipart upload (partial / outstanding)",
    ],
