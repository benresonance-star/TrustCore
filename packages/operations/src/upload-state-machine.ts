...
const transitions: Readonly<Record<UploadState, readonly UploadState[]>> = {
  ...
  authorised: ["temporary_upload_created", "failed_retryable", "failed_terminal"],
  temporary_upload_created: ["bytes_received", "failed_retryable", "quarantined"],
  bytes_received: ["hash_verified", "failed_retryable", "failed_terminal", "quarantined"],
  hash_verified: ["immutable_object_committed", "failed_retryable", "quarantined"],
  immutable_object_committed: ["metadata_committed", "failed_retryable", "quarantined"],
  metadata_committed: ["audit_committed", "failed_retryable", "quarantined"],
  audit_committed: ["completed", "failed_retryable"],
  completed: [],
  rejected: [],
  failed_retryable: ["authorised", "temporary_upload_created", "bytes_received", "hash_verified", "immutable_object_committed", "metadata_committed", "audit_committed", "failed_terminal", "quarantined"],
  failed_terminal: [],
  quarantined: [],
};

export class InvalidOperationTransition extends Error {
  constructor(readonly from: UploadState, readonly to: UploadState) {
